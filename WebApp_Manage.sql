...
-- 9 VLANs--
CREATE TABLE VLANs (
    VLANID INT PRIMARY KEY,              -- ID là số hiệu VLAN (1-4094)
    VLANName NVARCHAR(50) NOT NULL,      -- Tên vùng mạng
    SubnetMask NVARCHAR(50),             -- Dải IP (VD: 192.168.10.0/24)
    GatewayIP NVARCHAR(45),              -- IP của Gateway
    VLANColor NVARCHAR(7) DEFAULT '#007bff', -- Màu hiển thị trên Web
    Description NVARCHAR(200),           -- Mô tả chức năng
    Status BIT DEFAULT 1                 -- 1: Hoạt động, 0: Tạm khóa
);
...
INSERT INTO VLANs (VLANID, VLANName, SubnetMask, GatewayIP, VLANColor, Description)
VALUES 
(10, N'VLAN_Kỹ_Thuật', '192.168.10.0/24', '192.168.10.1', '#28a745', N'Quản trị hệ thống'),
(20, N'VLAN_Nhân Viên', '172.16.20.0/22', '172.16.20.1', '#ffc107', N'Wi-Fi Nhân Viên'),
(99, N'VLAN_Management', '10.0.99.0/24', '10.0.99.1', '#dc3545', N'Quản lý thiết bị');

-- Thêm dữ liệu mẫu thực tế
INSERT INTO VLANs (VLANID, VLANName, SubnetMask, GatewayIP, VLANColor, Description)
VALUES 
(10, N'VLAN_Kỹ_Thuật', '192.168.10.0/24', '192.168.10.1', '#28a745', N'Dành cho quản trị hệ thống'),
(20, N'VLAN_Nhân Viên', '172.16.20.0/22', '172.16.20.1', '#ffc107', N'Mạng Wi-Fi Nhân Viên'),
(99, N'VLAN_Management', '10.0.99.0/24', '10.0.99.1', '#dc3545', N'VLAN quản lý thiết bị');
